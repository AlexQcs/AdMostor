...
public class PlayingMusicServices extends Service {
    ...
    public final static String ACT_MUSIC_COMPLETE = "com.complete";
        ...
        if (mediaPlayer == null) {
            ...
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    ...
                    intent.setAction(ACT_MUSIC_COMPLETE);
...
//
                        ...
                        if (file.exists()) {
                            Log.e("MusicService", "文件存在");
                        } else {
                            Log.e("MusicService", "文件不存在");
                        }
